		...
		<div class="x_panel">
			...
			<div class="x_content">
				<div class="form-group">
					<label class="control-label col-sm-5">Formuli Pendaftaran*</label>
					<div class="col-sm-7">
				...
				<div class="form-group">
					<label class="control-label col-sm-5">Surat Rekomendasi Dinas Terkait*</label>
					<div class="col-sm-7">
				...
				<div class="form-group">
					<label class="control-label col-sm-5">Scan Kartu Keluarga*</label>
					<div class="col-sm-7">
						<input type="file" id="nama" class="form-control" name="kartu_keluarga" accept=".jpg,.jpeg,.png,application/pdf" required>
						<p>Silahkan mengupload kartu keluarga di sini</p>
					</div>
				</div>
				<div class="form-group">
