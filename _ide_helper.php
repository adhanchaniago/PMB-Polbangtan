 ...
 * Generated for Laravel 5.5.44 on 2019-01-08 11:52:07.
 *
...
namespace Brexis\LaravelWorkflow\Facades { 
    ...
    class WorkflowFacade {
        ...
        {
            return \Brexis\LaravelWorkflow\WorkflowRegistry::get($subject, $workflowName);
        }
        ...
        {
            return \Brexis\LaravelWorkflow\WorkflowRegistry::add($workflow, $supportStrategy);
        }
         ...
         * @static 
         */ 
        public static function addFromArray($name, $workflowData)
        {
            return \Brexis\LaravelWorkflow\WorkflowRegistry::addFromArray($name, $workflowData);
        }
...
namespace  { 
    ...
    class Workflow extends \Brexis\LaravelWorkflow\Facades\WorkflowFacade {}
